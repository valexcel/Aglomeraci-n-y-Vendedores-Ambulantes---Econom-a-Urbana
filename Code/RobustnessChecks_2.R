...
#
#        Proyecto Final - Pruebas de Robustez 2: Resultados Potenciales
#
...
simulaciones <- 1000  # Número de simulaciones
alfa <- 0.05  # Nivel de significancia
beta_real <- 0.5  # Efecto verdadero
...
simulaciones <- 1000  # Número de simulaciones
alfa <- 0.05  # Nivel de significancia
beta_real <-2.5   # Efecto verdadero
...
bias_results <- data.frame(
  Simulation = 1:simulations,
  True_Effect = 0.5,  # Efecto verdadero definido
  Estimated_Effect = numeric(simulations)
)
...
bias_results <- data.frame(
  Simulation = 1:simulations,
  True_Effect = 2.5,  # Efecto verdadero definido
  Estimated_Effect = numeric(simulations)
)
