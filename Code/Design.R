...
#
#                       Proyecto Final - Research Design
#
...
# personales y laborales cercanas a 150 personas. Se estima ademas que 
# las personas en el sector informal tienen menos conexiones que aquellas en el 
# sector formal. Si asumimos que el 30% de las conexiones son 
